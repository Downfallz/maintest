...
# Mirrors test_search_weights.TARGET, which is DEFAULT_WEIGHTS with kill and stun moved. This script runs as
...
TARGET = {"damage": 1.0, "kill": 8.0, "heal": 0.8, "bleed": 0.8, "defense": 0.65, "energy": 0.3}
TARGET["stun"] = 1.0
