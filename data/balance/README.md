...
picks from stacking. The shipped content now scores 5.30, where it scored 285.77, and what remains are findings
the samples prove. A tuning pass with these knobs is what they are for.
