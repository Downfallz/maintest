...
- **Targets**: the best target set of the declared spell, on the board at reveal time **minus the creatures
  ...
  against a board it carries forward and writes off who does not survive. That was 45.6 % of all fizzles
  (ADR 0039).
