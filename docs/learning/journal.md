...
- **What changed**: the mechanism of [ADR 0031](../adr/0031-an-effect-that-lands-on-the-caster.md), across the
  engine, the knobs tooling, the studio and the docs. **No content uses it yet**: the content hash stays
  `37ec4b49` and the existing digest still verifies 400 of 400, because an empty list is written away.
