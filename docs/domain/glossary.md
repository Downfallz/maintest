...
| Scoring weights | What the lookahead values in an action's expected outcome, eight of them: damage, kill, heal, stun, bleed, defense, energy kept, initiative. Only their ratios matter — the scorer is linear, so scaling all eight changes no decision. | decided |
