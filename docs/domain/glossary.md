...
| Effect | One consequence of a Spell on a target, from a closed taxonomy (ADR 0012, extended by ADR 0019, ADR 0020 and ADR 0035): instant `Damage`, `Heal`, `EnergyGain`, `EnergyDrain`; lasting `Bleed`, `Regeneration`, `EnergyRegeneration`, `Stun`, `DefenseBuff`, `DefenseDebuff`, `InitiativeDebuff` with a Duration and a Stacking policy. | decided |
