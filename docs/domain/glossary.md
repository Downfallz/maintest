...
| Scoring weights | What the lookahead values in an action's expected outcome, nine of them: damage, kill, heal, stun, bleed, defense, energy kept, fizzle, initiative. Only their ratios matter — the scorer is linear, so scaling all nine changes no decision. | decided |
