...
public sealed record CharacterSnapshot : ValueObject
{
    ...
    public static CharacterSnapshot From(CombatCreature character)
    {
        ArgumentNullException.ThrowIfNull(character);

        return new CharacterSnapshot(
            character.Id,
            character.OwnerSlot,              // assumes CombatCreature exposes OwnerSlot (PlayerSlot)
            character.Health,
            character.Energy,
