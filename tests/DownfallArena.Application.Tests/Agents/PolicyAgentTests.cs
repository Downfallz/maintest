...
public sealed class PolicyAgentTests
{
    ...
    public void The_factory_seats_a_policy_stamped_with_its_fingerprint_and_refuses_another_schema()
    {
        ...
        source.Load("other.json").Returns(Policy((RendIntent, 1.0)) with { SchemaId = "features:v4+000000000000" });
    ...
    public void A_policy_file_is_validated_against_the_contract()
    {
        ...
        Should.Throw<InvalidDataException>(() => (policy with { SchemaVersion = "features:v9", SchemaId = "features:v9+0123456789ab" }).Validated()).Message.ShouldContain("features:v4");
