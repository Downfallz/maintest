...
public sealed class JsonPolicySourceTests
{
    private const string Policy = """
        {
          "kind": "clone",
          "stamp": { "engineVersion": "abcdef123456", "contentHash": "c", "ruleSet": {}, "featureSchema": "features:v7+0123456789ab", "player1Agent": "Greedy", "player2Agent": "Greedy", "baseSeed": 1 },
          "schemaId": "features:v7+0123456789ab",
          "schemaVersion": "features:v7",
    ...
    public void A_policy_written_by_the_python_side_loads_with_its_fingerprint()
    {
        ...
        policy.SchemaId.ShouldBe("features:v7+0123456789ab");
    ...
    public void Incomplete_or_foreign_files_are_refused()
    {
        using var directory = new ContentDirectory()
            ...
            .WithFile("old-version.json", Policy.Replace("features:v7", "features:v0", StringComparison.Ordinal))
