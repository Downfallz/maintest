...
{
    public const string CurrentVersion = "features:v4";
    ...
    public static IReadOnlyList<string> ConditionKinds { get; } = ["Bleed", "Regeneration", "EnergyRegeneration", "Stun", "DefenseBuff", "DefenseDebuff", "InitiativeDebuff"];
